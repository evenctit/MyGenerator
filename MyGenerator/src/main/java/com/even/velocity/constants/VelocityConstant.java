...
public class VelocityConstant {
	...
	public final static String V_TEMPLATE_HELLO = "src/main/resources/velocity/hello.vm";
	public final static String V_TEMPLATE_MODEL = "src/main/resources/velocity/modelTemplate.vm";
	public final static String V_TEMPLATE_MODEL_VO = "src/main/resources/velocity/modelVoTemplate.vm";
	public final static String V_TEMPLATE_MODEL_QUERY = "src/main/resources/velocity/modelQueryTemplate.vm";
	public final static String V_TEMPLATE_DAO = "src/main/resources/velocity/daoTemplate.vm";
