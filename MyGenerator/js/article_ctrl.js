...
angular.module('misApp').controller('articleAddController', function($scope,$http,$routeParams,$location) {
	...
	if(typeof(id) != "undefined") {
		...
		.success(function (response) {
							...
							$scope.createDate = response.article.createDate;
							$scope.createBy = response.article.createBy;
							$scope.updateDate = response.article.updateDate;
							$scope.updateBy = response.article.updateBy;
